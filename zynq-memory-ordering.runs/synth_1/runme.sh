...
HD_PWD=/opt/Xilinx/Projects/zynq-memory-ordering/zynq-memory-ordering.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log block_diagram_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source block_diagram_wrapper.tcl
