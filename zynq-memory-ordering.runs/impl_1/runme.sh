...
HD_PWD=/opt/Xilinx/Projects/zynq-memory-ordering/zynq-memory-ordering.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log block_diagram_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source block_diagram_wrapper.tcl -notrace
