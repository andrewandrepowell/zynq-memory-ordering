...
/* Andrew Powell - The following globals were
added so that extraneous output could be avoided. */
int pcEchoFlag=1;
...
xComPortHandle xPort;
	...
	if (pcCmdCharsFlag) vSerialPutString( xPort, ( signed char * ) pcWelcomeMessage, ( unsigned short ) strlen( pcWelcomeMessage ) );
