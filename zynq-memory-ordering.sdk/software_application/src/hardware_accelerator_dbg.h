...
#define Hardware_Accelerator_ADDR_BURST_SIZE				HARDWARE_ACCELERATOR_s_axi_lite_registers_SLV_REG0_OFFSET
#define Hardware_Accelerator_ADDR_TRANSFER_SIZE				HARDWARE_ACCELERATOR_s_axi_lite_registers_SLV_REG1_OFFSET
#define Hardware_Accelerator_ADDR_WRITE_ADDRESS				HARDWARE_ACCELERATOR_s_axi_lite_registers_SLV_REG2_OFFSET
#define Hardware_Accelerator_ADDR_READ_ADDRESS				HARDWARE_ACCELERATOR_s_axi_lite_registers_SLV_REG3_OFFSET
#define Hardware_Accelerator_ADDR_WRITE_COHERENT_FLAG		HARDWARE_ACCELERATOR_s_axi_lite_registers_SLV_REG4_OFFSET
#define Hardware_Accelerator_ADDR_READ_COHERENT_FLAG		HARDWARE_ACCELERATOR_s_axi_lite_registers_SLV_REG5_OFFSET
